    ...
    types: [
      {
        ...
        ingredients: [
          ...
          { ingredient: "Bacon", cost: 0 },
          { ingredient: "Avocado", cost: 0 },
          { ingredient: "Pickle Slices", cost: 0 },
          { ingredient: "Tomato Slices", cost: 0 },
          { ingredient: "Onion Slices", cost: 0 },
          { ingredient: "Special Sauce", cost: 0 },
        ],
        description:
    ...
    types: [
      {
        ...
        ingredients: [
          ...
          { ingredient: "Cheese Sauce", cost: 0 },
          { ingredient: "Spices", cost: 0 },
          { ingredient: "Garlic Powder", cost: 0 },
          { ingredient: "Onion Powder", cost: 0 },
          { ingredient: "Paprika", cost: 0 },
          { ingredient: "Black Pepper", cost: 0 },
          { ingredient: "Cayenne Pepper", cost: 0 },
          { ingredient: "Rosemary", cost: 0 },
          { ingredient: "Thyme", cost: 0 },
          { ingredient: "Parmesan Cheese", cost: 0 },
          { ingredient: "Chives", cost: 0 },
          { ingredient: "Bacon Bits", cost: 0 },
        ],
        description:
    ...
    types: [
      {
        ...
        ingredients: [
          ...
          { ingredient: "Cheese Sauce", cost: 0 },
          { ingredient: "Chili Powder", cost: 0 },
          { ingredient: "Cayenne Pepper", cost: 0 },
          { ingredient: "Mustard", cost: 0 },
          { ingredient: "BBQ Sauce", cost: 0 },
        ],
        description:
    ...
    types: [
      {
        ...
        ingredients: [
          ...
          { ingredient: "Citric Acid", cost: 0 },
          { ingredient: "Caramel Color", cost: 0 },
          { ingredient: "Phosphoric Acid", cost: 0 },
          { ingredient: "Natural Flavors", cost: 0 },
          { ingredient: "Vanilla Extract", cost: 0 },
          { ingredient: "Lime Extract", cost: 0 },
          { ingredient: "Orange Extract", cost: 0 },
          { ingredient: "Lemon Extract", cost: 0 },
          { ingredient: "Cherry Extract", cost: 0 },
          { ingredient: "Root Beer Extract", cost: 0 },
          { ingredient: "Alcohol", cost: 0 },
          { ingredient: "Salt", cost: 0 },
        ],
        description:
      ...
      },
      {
        ...
        ingredients: [
          ...
          { ingredient: "Lime Juice", cost: 0 },
          { ingredient: "Orange Juice", cost: 0 },
          { ingredient: "Lemon Extract", cost: 0 },
          { ingredient: "Ice", cost: 0 },
          { ingredient: "Mint Leaves", cost: 0 },
          { ingredient: "Soda Water", cost: 0 },
          { ingredient: "Salt", cost: 0 },
          { ingredient: "Vinegar", cost: 0 },
          { ingredient: "Soy Sauce", cost: 0 },
          { ingredient: "Butter", cost: 0 },
          { ingredient: "Vanilla", cost: 0 },
          { ingredient: "Thyme", cost: 0 },
        ],
        description:
      ...
      },
      {
        ...
        ingredients: [
          ...
          { ingredient: "Ice", cost: 0 },
          { ingredient: "Milk", cost: 0 },
          { ingredient: "Caramel", cost: 0 },
          { ingredient: "Whiskey", cost: 0 },
          { ingredient: "Gin", cost: 0 },
          { ingredient: "Vodka", cost: 0 },
          { ingredient: "Rum", cost: 0 },
          { ingredient: "Beer", cost: 0 },
          { ingredient: "Wine", cost: 0 },
          { ingredient: "Coffee", cost: 0 },
          { ingredient: "Water", cost: 0 },
          { ingredient: "Lemon Juice", cost: 0 },
        ],
        description:
